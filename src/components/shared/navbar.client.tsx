        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          >
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              ...
              <SheetContent
                side="left"
                className="mobile-nav-panel flex h-screen w-screen flex-col overflow-hidden border-none bg-[color:var(--mobile-nav-surface)] text-[color:var(--mobile-nav-text)] shadow-[0_48px_160px_rgba(8,6,20,0.55)] transition-[transform,width] duration-500 ease-[cubic-bezier(.22,.61,.36,1)] data-[state=closed]:pointer-events-none data-[state=closed]:w-0 data-[state=closed]:border-transparent data-[state=closed]:shadow-none"
              >
